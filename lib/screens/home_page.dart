...
import 'package:furnitureapp/models/collection_detail_model.dart';
import 'package:furnitureapp/models/collection_model.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      Text.rich(
                        TextSpan(
                          text:
                              " The new Flexfrom outdoor collection is\n permeated with fresh inventive style"
                              " and\n pioneering desing research.",
                          style:
...
class CollectionDetailPage extends StatefulWidget {
  ...
  const CollectionDetailPage({Key? key, required this.collectionType})
      : super(key: key);
              ...
              children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: AppColors.tertiaryColor.withOpacity(.8),
                  ),
                  child: Text.rich(
                    TextSpan(
...
class CurvePath extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
        size.width * .5, size.height, size.width, size.height * .85);
    path.lineTo(w, 0);
    path.close();
